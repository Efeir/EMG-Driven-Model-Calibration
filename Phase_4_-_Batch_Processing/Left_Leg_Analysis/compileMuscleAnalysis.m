...
for i = 1:nTrials(1)
    ...
    MAFileHipFlex = [name '_MuscleAnalysis_MomentArm_hip_flexion_l.sto'];
    MAFileHipAA = [name '_MuscleAnalysis_MomentArm_hip_adduction_l.sto'];
    MAFileKnee = [name '_MuscleAnalysis_MomentArm_knee_angle_l.sto'];
    MAFileAnkle = [name '_MuscleAnalysis_MomentArm_ankle_angle_l.sto'];
    MAFileSubtalar = [name '_MuscleAnalysis_MomentArm_subtalar_angle_l.sto'];
...
%     cd(dirOrig);
%     outFile = [name '_muscle_analysis_l.xls'];
...
cd(dirOrig);
save muscle_analysis_l_results.mat muscAnalysisData
